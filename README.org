...
** Usage
   ...
   You can also generate code-based migrations:
   
   : lein migratus create-add-users-table :edn
   
   This will generate a .edn file which should be filled out like this:
   : {:ns my.migration.namespace
   :  :up-fn apply-migration-fn
   :  :down-fn undo-migration-fn}
